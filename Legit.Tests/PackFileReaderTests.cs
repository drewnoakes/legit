        ...
        public void ReadObject_Tree()
        {
            ...
            */
            var expected = new byte[]
            {
                ...
                32,
                // "Boing.csproj\0"
                66, 111, 105, 110, 103, 46, 99, 115, 112, 114, 111, 106, 0,
                // SHA-1
                0x04, 0xCA, 0xBD, 142, 207, 75, 240, 116, 21, 105, 193, 173, 217, 185, 58, 142, 155, 237, 218, 97,
                // repeat...
                49, 48, 48, 54, 52, 52,
        ...
        public void ReadObject_Commit()
        {
            ...
            */
            ...
            var expected = new byte[]
            {
                ...
                32,
                // SHA-1 in ASCII
                52, 100, 97, 55, 49, 57, 52, 100, 49, 98, 57, 99, 100, 52, 98, 98, 100, 101, 100, 56,
                48, 102, 98, 55, 52, 54, 56, 102, 49, 50, 49, 50, 50, 97, 54, 97, 97, 98, 97, 50,
                10,
                112, 97, 114, 101, 110, 116,
                32,
                55, 97, 54, 56, 98, 48, 98, 100, 52, 54, 99, 48, 56, 51, 102, 52, 98, 98, 49,
