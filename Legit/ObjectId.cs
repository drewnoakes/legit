...
namespace Legit
{
    ...
    public readonly struct ObjectId : IEquatable<ObjectId>
    {
        ...
        private readonly uint _i1, _i2, _i3, _i4, _i5;
        ...
        public byte Byte0 => (byte)(_i1 >> 24);

        public int CompareTo(BigEndianBinaryReader reader)
        {
            var c = _i1.CompareTo(reader.ReadUInt32BE());
            if (c != 0)
                return c;
            c = _i2.CompareTo(reader.ReadUInt32BE());
            if (c != 0)
                return c;
            c = _i3.CompareTo(reader.ReadUInt32BE());
            if (c != 0)
                return c;
            c = _i4.CompareTo(reader.ReadUInt32BE());
            if (c != 0)
                return c;
            return _i5.CompareTo(reader.ReadUInt32BE());
        }
    }
}
